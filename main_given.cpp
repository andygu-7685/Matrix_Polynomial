...
// Written by: Kenneth R. Glover - gloverk@colorado.eduV

#include <cctype>          // Provides toupper
#include <iostream>        // Provides cout and cin
#include <cstdlib>         // Provides EXIT_SUCCESS
#include "./includes/poly_list/polynomial.h"         // Provides the polynomial class
using namespace std;
...
//     for(int i = 0; i < 10; i++){
//         test.find_root(answer, success, iteration, i * 10, 100, 0.0001);
//         if(success)
//             roots.push_back(answer);
//     }

//     cout << "following are the roots of the polynomial in x = 0 - 100\n";
...
char get_command()
{
    ...
    cout << ">";
    if (!(cin >> command)) {
        return 'Q'; // Force a Quit if cin fails (End of File)
    }
...
size_t set_current( )
{
    ...
    do
    {
      ...
      command = toupper(get_command());
      cout << "Selected polynomial: " << command << endl;
    }
...
void test_add(polynomial& test)
{
    ...
    cout << "Enter exponent: ";
    cin >> exponent;
    cout << "Read exponent: " << exponent << endl;

    cout << "Enter coefficient: ";
    cin >> coefficient;
    cout << "Read coefficient: " << coefficient << endl;
...
void test_gif(const polynomial& test)
{
    ...
    cin >> high_x;
    cout << "Read upper x bound: " << high_x << endl;

    cout << "Enter lower x bound: ";
    cin >> low_x;
    cout << "Read lower x bound: " << low_x << endl;

    cout << "Enter upper y bound: ";
    cin >> high_y;
    cout << "Read upper y bound: " << high_y << endl;

    cout << "Enter lower y bound: ";
    cin >> low_y;
    cout << "Read lower y bound: " << low_y << endl;
...
void test_eval(const polynomial& test)
{
    ...
    cin >> x_value;
    cout << "Read x value: " << x_value << endl;
